...
class L {
  ...
  static const Map<String, List<String>> _m = {
    ...
    'track_auto': ['Automatisch', 'Automatic', 'Otomatik', 'تلقائي', 'Automatique', 'Automatico', 'Αυτόματο'],
    'download': ['Herunterladen', 'Download', 'İndir', 'تنزيل', 'Télécharger', 'Scarica', 'Λήψη'],
    'download_all': ['Ganze Serie laden', 'Download whole series', 'Tüm diziyi indir', 'تنزيل المسلسل كامل', 'Télécharger toute la série', 'Scarica tutta la serie', 'Λήψη όλης της σειράς'],
    'downloads': ['Downloads', 'Downloads', 'İndirilenler', 'التنزيلات', 'Téléchargements', 'Download', 'Λήψεις'],
