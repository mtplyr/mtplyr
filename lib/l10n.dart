...
class L {
  ...
  static const Map<String, List<String>> _m = {
    ...
    'activate_s2': ['Code + deine M3U-/Xtream-Playlist eingeben', 'Enter the code + your M3U/Xtream playlist', 'Kodu + M3U/Xtream listeni gir', 'أدخل الرمز + قائمة M3U/Xtream', 'Saisir le code + votre playlist M3U/Xtream', 'Inserisci il codice + la tua playlist M3U/Xtream', 'Βάλε τον κωδικό + τη λίστα M3U/Xtream'],
